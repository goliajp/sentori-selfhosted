 ...
 */
export type { App, Breadcrumb, BreadcrumbType, CaptureExtras, Device, DeviceOS, Event, EventKind, Frame, Platform, ReadyInfo, SentoriError, Tags, User, } from '@goliapkg/sentori-core';
import type { BeforeSendHook, CommonInitOptions, LogLevel, ReadyInfo } from '@goliapkg/sentori-core';
