 ...
 *     })
 */
export declare function safeFn<TArgs extends readonly unknown[], R>(name: string, fn: (...args: TArgs) => R): (...args: TArgs) => R | undefined;
/**
 * Wrap an async function so it can never reject. The returned
 * promise always resolves; on internal failure it resolves to
 * `undefined`.
 */
export declare function safeAsync<TArgs extends readonly unknown[], R>(name: string, fn: (...args: TArgs) => Promise<R>): (...args: TArgs) => Promise<R | undefined>;
