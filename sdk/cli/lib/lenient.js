...
// guarantee.
export const isStrict = (argv) => argv.includes('--strict');
/** Strip --strict before handing argv to parseArgs. */
export const stripStrict = (argv) => argv.filter((a) => a !== '--strict');
export const lenientFail = (strict, o) => {
    ...
    console.error('[sentori]   Events received in the meantime are re-symbolicated automatically after upload.');
    if (strict) {
...
//# sourceMappingURL=lenient.js.map